...
class InsightSalesHarian extends StatefulWidget {
  final UserModelInsight model;
  InsightSalesHarian(this.model);
  @override
  _InsightSalesHarianState createState() => _InsightSalesHarianState();
}

class _InsightSalesHarianState extends State<InsightSalesHarian> {
  var isLoading = false;
  var isData = false;
