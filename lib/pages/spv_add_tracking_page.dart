...
class SpvAddTracking extends StatefulWidget {
  final LeadModel model;
  final VoidCallback reload;
  SpvAddTracking(this.model, this.reload);

  @override
  _SpvAddTrackingState createState() => _SpvAddTrackingState();
}

class _SpvAddTrackingState extends State<SpvAddTracking> {
  var isLoading = false;
