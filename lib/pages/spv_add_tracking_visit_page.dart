...
class SpvAddTrackingVsit extends StatefulWidget {
  final VisitModel model;
  final VoidCallback reload;

  SpvAddTrackingVsit(this.model, this.reload);

  @override
  _SpvAddTrackingVsitState createState() => _SpvAddTrackingVsitState();
}

class _SpvAddTrackingVsitState extends State<SpvAddTrackingVsit> {
  var isLoading = false;
