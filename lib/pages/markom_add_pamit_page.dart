...
class MarkomAddPamitPage extends StatefulWidget {
  const MarkomAddPamitPage({Key? key}) : super(key: key);

  @override
  _MarkomAddPamitPageState createState() => _MarkomAddPamitPageState();
}

class _MarkomAddPamitPageState extends State<MarkomAddPamitPage> {
  var isLoading = false;
  ...
  getNotif() async {
    SharedPreferences pref = await SharedPreferences.getInstance();
    final response = await http.post(Uri.parse(BaseUrl.notifPamit), body: {
