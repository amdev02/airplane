...
import 'package:varana_apps/pages/spv_reschedule_page.dart';
...
class SpvDetailAkanDatang extends StatefulWidget {
  final VisitModel model;
  SpvDetailAkanDatang(this.model);

  @override
  _SpvDetailAkanDatangState createState() => _SpvDetailAkanDatangState();
}

class _SpvDetailAkanDatangState extends State<SpvDetailAkanDatang> {
  var isLoading = false;
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SpvReschedulePage(widget.model)));
                },
                child: Text(
                  "Re Schedule",
                  style: whiteTextStyle,
