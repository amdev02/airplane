...
class HmDetailKprPage extends StatefulWidget {
  final LeadModel model;
  HmDetailKprPage(this.model);

  @override
  _HmDetailKprPageState createState() => _HmDetailKprPageState();
}

class _HmDetailKprPageState extends State<HmDetailKprPage> {
  var isLoading = false;
