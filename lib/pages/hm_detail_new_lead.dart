...
class HmDetailNewLeadPage extends StatefulWidget {
  final LeadModel model;
  HmDetailNewLeadPage(this.model);

  @override
  _HmDetailNewLeadPageState createState() => _HmDetailNewLeadPageState();
}

class _HmDetailNewLeadPageState extends State<HmDetailNewLeadPage> {
  var isLoading = false;
