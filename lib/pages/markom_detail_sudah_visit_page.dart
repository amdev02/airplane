...
class MarkomDetailSudahVisitPage extends StatefulWidget {
  ...
  MarkomDetailSudahVisitPage(this.model);

  @override
  _MarkomDetailSudahVisitPageState createState() =>
      _MarkomDetailSudahVisitPageState();
}

class _MarkomDetailSudahVisitPageState
    extends State<MarkomDetailSudahVisitPage> {
  @override
  var isLoading = false;
