...
class SalesAddSoldPage extends StatefulWidget {
  final LeadModel model;
  SalesAddSoldPage(this.model);
  @override
  _SalesAddSoldPageState createState() => _SalesAddSoldPageState();
}

class _SalesAddSoldPageState extends State<SalesAddSoldPage> {
  var isLoading = false;
  var bankSelection;
