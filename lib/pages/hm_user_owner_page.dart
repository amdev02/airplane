...
import 'package:varana_apps/pages/hm_user_add_owner.dart';
...
class HmUserOwnerPage extends StatefulWidget {
  const HmUserOwnerPage({Key? key}) : super(key: key);

  @override
  _HmUserOwnerPageState createState() => _HmUserOwnerPageState();
}

class _HmUserOwnerPageState extends State<HmUserOwnerPage> {
  var isLoading = false;
  var isData = false;
  ...
  getUser() async {
    ...
    list.clear();
    final response = await http.get(Uri.parse(BaseUrl.getOwner));
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => HmUserAddOwner(getUser)));
        },
        child: Icon(
          Icons.add,
          color: kWhiteColor,
