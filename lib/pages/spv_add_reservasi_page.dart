...
class SpvAddReservasiPage extends StatefulWidget {
  final LeadModel model;
  SpvAddReservasiPage(this.model);

  @override
  _SpvAddReservasiPageState createState() => _SpvAddReservasiPageState();
}

class _SpvAddReservasiPageState extends State<SpvAddReservasiPage> {
  var rumahSelection;
