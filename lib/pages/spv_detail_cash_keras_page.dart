...
class SpvDetailCashKeras extends StatefulWidget {
  final LeadModel model;
  SpvDetailCashKeras(this.model);

  @override
  _SpvDetailCashKerasState createState() => _SpvDetailCashKerasState();
}

class _SpvDetailCashKerasState extends State<SpvDetailCashKeras> {
  var isLoading = false;
