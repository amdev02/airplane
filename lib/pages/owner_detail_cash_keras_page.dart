...
class OwnerDetailCashKerasPage extends StatefulWidget {
  final LeadModel model;
  OwnerDetailCashKerasPage(this.model);

  @override
  _OwnerDetailCashKerasPageState createState() =>
      _OwnerDetailCashKerasPageState();
}

class _OwnerDetailCashKerasPageState extends State<OwnerDetailCashKerasPage> {
  var isLoading = false;
