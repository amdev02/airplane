...
class SpvAddFollowUp extends StatefulWidget {
  final LeadModel model;
  SpvAddFollowUp(this.model);
  @override
  _SpvAddFollowUpState createState() => _SpvAddFollowUpState();
}

class _SpvAddFollowUpState extends State<SpvAddFollowUp> {
  var isLoading = false;
