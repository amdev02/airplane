...
class SalesDetailSoldKpr extends StatefulWidget {
  ...
  SalesDetailSoldKpr(this.model);

  @override
  _SalesDetailSoldKprState createState() => _SalesDetailSoldKprState();
}

class _SalesDetailSoldKprState extends State<SalesDetailSoldKpr> {
  var isLoading = false;
