...
class SalesAbsenToday extends StatefulWidget {
  const SalesAbsenToday({Key? key}) : super(key: key);

  @override
  _SalesAbsenTodayState createState() => _SalesAbsenTodayState();
}

class _SalesAbsenTodayState extends State<SalesAbsenToday> {
  var isLoading = false;
  var isData = false;
