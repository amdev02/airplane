...
import 'package:varana_apps/pages/sales_detail_sold_kpr_page.dart';
...
class SalesKprPage extends StatefulWidget {
  const SalesKprPage({Key? key}) : super(key: key);

  @override
  _SalesKprPageState createState() => _SalesKprPageState();
}

class _SalesKprPageState extends State<SalesKprPage> {
  var isLoading = false;
  var isData = false;
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => SalesDetailSoldKpr(a)));
                        },
                        child: Container(
