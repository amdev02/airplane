...
class HmDetailFollowUp extends StatefulWidget {
  final LeadModel model;
  HmDetailFollowUp(this.model);

  @override
  _HmDetailFollowUpState createState() => _HmDetailFollowUpState();
}

class _HmDetailFollowUpState extends State<HmDetailFollowUp> {
  var isLoading = false;
