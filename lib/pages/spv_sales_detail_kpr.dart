...
class SpvSalesDetailKpr extends StatefulWidget {
  final LeadModel model;
  SpvSalesDetailKpr(this.model);

  @override
  _SpvSalesDetailKprState createState() => _SpvSalesDetailKprState();
}

class _SpvSalesDetailKprState extends State<SpvSalesDetailKpr> {
  var isLoading = false;
