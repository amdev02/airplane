...
class SalesTambahBooking extends StatefulWidget {
  final LeadModel model;
  SalesTambahBooking(this.model);

  @override
  _SalesTambahBookingState createState() => _SalesTambahBookingState();
}

class _SalesTambahBookingState extends State<SalesTambahBooking> {
  var isLoading = false;
