...
import 'package:varana_apps/pages/hm_detail_cash_bertahap.dart';
...
class HmCashBertahap extends StatefulWidget {
  const HmCashBertahap({Key? key}) : super(key: key);

  @override
  _HmCashBertahapState createState() => _HmCashBertahapState();
}

class _HmCashBertahapState extends State<HmCashBertahap> {
  var isLoading = false;
  var isData = false;
