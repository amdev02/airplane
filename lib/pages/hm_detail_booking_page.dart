...
class HmDetailBookingPage extends StatefulWidget {
  final LeadModel model;
  HmDetailBookingPage(this.model);

  @override
  _HmDetailBookingPageState createState() => _HmDetailBookingPageState();
}

class _HmDetailBookingPageState extends State<HmDetailBookingPage> {
  var isLoading = false;
