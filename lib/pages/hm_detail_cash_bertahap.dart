...
class HmDetailCashBertahap extends StatefulWidget {
  final LeadModel model;
  HmDetailCashBertahap(this.model);
  @override
  _HmDetailCashBertahapState createState() => _HmDetailCashBertahapState();
}

class _HmDetailCashBertahapState extends State<HmDetailCashBertahap> {
  var isLoading = false;
