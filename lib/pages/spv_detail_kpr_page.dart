...
class SpvDetailKprPage extends StatefulWidget {
  final LeadModel model;
  SpvDetailKprPage(this.model);

  @override
  _SpvDetailKprPageState createState() => _SpvDetailKprPageState();
}

class _SpvDetailKprPageState extends State<SpvDetailKprPage> {
  var isLoading = false;
