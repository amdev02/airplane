...
class MarkomAbsenAllPage extends StatefulWidget {
  @override
  _MarkomAbsenAllPageState createState() => _MarkomAbsenAllPageState();
}

class _MarkomAbsenAllPageState extends State<MarkomAbsenAllPage> {
  var isLoading = false;
  var isData = false;
