...
class OwnerDetailBookingPage extends StatefulWidget {
  final LeadModel model;
  OwnerDetailBookingPage(this.model);
  @override
  _OwnerDetailBookingPageState createState() => _OwnerDetailBookingPageState();
}

class _OwnerDetailBookingPageState extends State<OwnerDetailBookingPage> {
  var isLoading = false;
