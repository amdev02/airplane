...
import 'package:varana_apps/pages/owner_detail_sudah_datang.dart';
...
class OwnerSudahVisitPage extends StatefulWidget {
  const OwnerSudahVisitPage({Key? key}) : super(key: key);

  @override
  _OwnerSudahVisitPageState createState() => _OwnerSudahVisitPageState();
}

class _OwnerSudahVisitPageState extends State<OwnerSudahVisitPage> {
  var isLoading = false;
  var isData = false;
