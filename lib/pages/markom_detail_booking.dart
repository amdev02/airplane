...
class MarkomDetailBookingPage extends StatefulWidget {
  final LeadModel model;
  MarkomDetailBookingPage(this.model);
  @override
  _MarkomDetailBookingPageState createState() =>
      _MarkomDetailBookingPageState();
}

class _MarkomDetailBookingPageState extends State<MarkomDetailBookingPage> {
  var isLoading = false;
