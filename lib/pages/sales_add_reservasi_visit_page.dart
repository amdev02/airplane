...
class SalesTambahReservasiVisit extends StatefulWidget {
  final VisitModel model;
  SalesTambahReservasiVisit(this.model);
  @override
  _SalesTambahReservasiVisitState createState() =>
      _SalesTambahReservasiVisitState();
}

class _SalesTambahReservasiVisitState extends State<SalesTambahReservasiVisit> {
  var rumahSelection;
