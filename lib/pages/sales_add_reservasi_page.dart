...
import 'package:varana_apps/models/rumah_model.dart';
import 'package:varana_apps/services/api.dart';
import 'package:varana_apps/theme/thema.dart';
import 'package:varana_apps/widget/button_in_loading.dart';

class SalesTambahReservasi extends StatefulWidget {
  final LeadModel model;
  SalesTambahReservasi(this.model);

  @override
  _SalesTambahReservasiState createState() => _SalesTambahReservasiState();
}

class _SalesTambahReservasiState extends State<SalesTambahReservasi> {
  var rumahSelection;
