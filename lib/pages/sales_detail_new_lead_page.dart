...
import 'package:varana_apps/pages/sales_add_follow_up.dart';
...
class SalesDetailNewLead extends StatefulWidget {
  final LeadModel model;
  SalesDetailNewLead(this.model);

  @override
  _SalesDetailNewLeadState createState() => _SalesDetailNewLeadState();
}

class _SalesDetailNewLeadState extends State<SalesDetailNewLead> {
  var isLoading = false;
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            SalesTambahFollowUp(widget.model)));
              },
              child: Text(
                "Follow Up",
                style: whiteTextStyle,
