...
import 'package:varana_apps/pages/sales_add_akan_visit.dart';
import 'package:varana_apps/pages/sales_add_reservasi_page.dart';
...
class SalesDetailFollowup extends StatefulWidget {
  final LeadModel model;
  SalesDetailFollowup(this.model);
  @override
  _SalesDetailFollowupState createState() => _SalesDetailFollowupState();
}

class _SalesDetailFollowupState extends State<SalesDetailFollowup> {
  var isLoading = false;
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SalesTambahReservasi(widget.model)));
                },
                child: Text(
                  "Reservasi",
                  style: whiteTextStyle,
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SalesTambahAkanVisit(widget.model)));
                },
                child: Text(
                  "Visit",
                  style: whiteTextStyle,
