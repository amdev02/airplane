...
class InsightMarkomMingguan extends StatefulWidget {
  final UserModelInsight model;
  InsightMarkomMingguan(this.model);

  @override
  _InsightMarkomMingguanState createState() => _InsightMarkomMingguanState();
}

class _InsightMarkomMingguanState extends State<InsightMarkomMingguan> {
  var isLoading = false;
  var isData = false;
