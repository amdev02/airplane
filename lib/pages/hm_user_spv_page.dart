...
import 'package:varana_apps/pages/hm_user_add_spv_page.dart';
...
class HmUserSpvPage extends StatefulWidget {
  const HmUserSpvPage({Key? key}) : super(key: key);

  @override
  _HmUserSpvPageState createState() => _HmUserSpvPageState();
}

class _HmUserSpvPageState extends State<HmUserSpvPage> {
  var isLoading = false;
  var isData = false;
  ...
  getUser() async {
    ...
    list.clear();
    final response = await http.get(Uri.parse(BaseUrl.getSpv));
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => HmUserAddSpvPage(getUser)));
        },
        child: Icon(
          Icons.add,
          color: kWhiteColor,
