...
class SalesDetailCashBertahap extends StatefulWidget {
  ...
  SalesDetailCashBertahap(this.model);

  @override
  _SalesDetailCashBertahapState createState() =>
      _SalesDetailCashBertahapState();
}

class _SalesDetailCashBertahapState extends State<SalesDetailCashBertahap> {
  var isLoading = false;
