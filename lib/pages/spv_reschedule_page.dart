...
class SpvReschedulePage extends StatefulWidget {
  final VisitModel model;
  SpvReschedulePage(this.model);

  @override
  _SpvReschedulePageState createState() => _SpvReschedulePageState();
}

class _SpvReschedulePageState extends State<SpvReschedulePage> {
  var isLoading = false;
