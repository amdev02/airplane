...
class MarkomAddAbsensiPage extends StatefulWidget {
  @override
  _MarkomAddAbsensiPageState createState() => _MarkomAddAbsensiPageState();
}

class _MarkomAddAbsensiPageState extends State<MarkomAddAbsensiPage> {
  var isLoading = false;
