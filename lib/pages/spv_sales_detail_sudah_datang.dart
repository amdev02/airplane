...
class SpvSalesDetailSudahDatang extends StatefulWidget {
  final VisitModel model;
  SpvSalesDetailSudahDatang(this.model);
  @override
  _SpvSalesDetailSudahDatangState createState() =>
      _SpvSalesDetailSudahDatangState();
}

class _SpvSalesDetailSudahDatangState extends State<SpvSalesDetailSudahDatang> {
  var isLoading = false;
