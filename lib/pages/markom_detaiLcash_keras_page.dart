...
class MarkomDetailCashKerasPage extends StatefulWidget {
  final LeadModel model;
  MarkomDetailCashKerasPage(this.model);

  @override
  _MarkomDetailCashKerasPageState createState() =>
      _MarkomDetailCashKerasPageState();
}

class _MarkomDetailCashKerasPageState extends State<MarkomDetailCashKerasPage> {
  var isLoading = false;
