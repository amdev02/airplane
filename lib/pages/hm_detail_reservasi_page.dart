...
class HmDetailReservasi extends StatefulWidget {
  final LeadModel model;
  HmDetailReservasi(this.model);

  @override
  _HmDetailReservasiState createState() => _HmDetailReservasiState();
}

class _HmDetailReservasiState extends State<HmDetailReservasi> {
  var isLoading = false;
