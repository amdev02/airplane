...
import 'package:varana_apps/pages/sales_detail_cash_keras_page.dart';
...
class SalesCashKerasPage extends StatefulWidget {
  const SalesCashKerasPage({Key? key}) : super(key: key);

  @override
  _SalesCashKerasPageState createState() => _SalesCashKerasPageState();
}

class _SalesCashKerasPageState extends State<SalesCashKerasPage> {
  var isLoading = false;
  var isData = false;
