...
class OwnerDetailAkanVisitPage extends StatefulWidget {
  final VisitModel model;
  OwnerDetailAkanVisitPage(this.model);
  @override
  _OwnerDetailAkanVisitPageState createState() =>
      _OwnerDetailAkanVisitPageState();
}

class _OwnerDetailAkanVisitPageState extends State<OwnerDetailAkanVisitPage> {
  var isLoading = false;
