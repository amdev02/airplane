...
class MarkomDetailFollowUpPage extends StatefulWidget {
  final LeadModel model;
  MarkomDetailFollowUpPage(this.model);
  @override
  _MarkomDetailFollowUpPageState createState() =>
      _MarkomDetailFollowUpPageState();
}

class _MarkomDetailFollowUpPageState extends State<MarkomDetailFollowUpPage> {
  var isLoading = false;
