...
class OwnerDetailCashBertahap extends StatefulWidget {
  final LeadModel model;
  OwnerDetailCashBertahap(this.model);
  @override
  _OwnerDetailCashBertahapState createState() =>
      _OwnerDetailCashBertahapState();
}

class _OwnerDetailCashBertahapState extends State<OwnerDetailCashBertahap> {
  var isLoading = false;
