...
class InsightMarkomBulanan extends StatefulWidget {
  final UserModelInsight model;
  InsightMarkomBulanan(this.model);

  @override
  _InsightMarkomBulananState createState() => _InsightMarkomBulananState();
}

class _InsightMarkomBulananState extends State<InsightMarkomBulanan> {
  var isLoading = false;
  var isData = false;
