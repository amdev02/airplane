...
class SpvSalesDetailCashBertahap extends StatefulWidget {
  final LeadModel model;
  SpvSalesDetailCashBertahap(this.model);

  @override
  _SpvSalesDetailCashBertahapState createState() =>
      _SpvSalesDetailCashBertahapState();
}

class _SpvSalesDetailCashBertahapState
    extends State<SpvSalesDetailCashBertahap> {
  var isLoading = false;
