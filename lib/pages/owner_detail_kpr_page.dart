...
class OwnerDetailKprPage extends StatefulWidget {
  final LeadModel model;
  OwnerDetailKprPage(this.model);
  @override
  _OwnerDetailKprPageState createState() => _OwnerDetailKprPageState();
}

class _OwnerDetailKprPageState extends State<OwnerDetailKprPage> {
  var isLoading = false;
