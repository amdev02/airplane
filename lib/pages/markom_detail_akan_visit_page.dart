...
class MarkomDetailAkanVisitPage extends StatefulWidget {
  final VisitModel model;
  MarkomDetailAkanVisitPage(this.model);
  @override
  _MarkomDetailAkanVisitPageState createState() =>
      _MarkomDetailAkanVisitPageState();
}

class _MarkomDetailAkanVisitPageState extends State<MarkomDetailAkanVisitPage> {
  var isLoading = false;
