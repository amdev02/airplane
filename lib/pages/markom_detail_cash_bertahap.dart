...
class MarkomDetailCashBertahap extends StatefulWidget {
  final LeadModel model;
  MarkomDetailCashBertahap(this.model);
  @override
  _MarkomDetailCashBertahapState createState() =>
      _MarkomDetailCashBertahapState();
}

class _MarkomDetailCashBertahapState extends State<MarkomDetailCashBertahap> {
  var isLoading = false;
