...
class OwnerDetailSudahVisit extends StatefulWidget {
  final VisitModel model;
  OwnerDetailSudahVisit(this.model);

  @override
  _OwnerDetailSudahVisitState createState() => _OwnerDetailSudahVisitState();
}

class _OwnerDetailSudahVisitState extends State<OwnerDetailSudahVisit> {
  @override
  var isLoading = false;
