...
import 'package:varana_apps/pages/spv_sales_detail_reservasi.dart';
...
class SpvSalesReservasi extends StatefulWidget {
  const SpvSalesReservasi({Key? key}) : super(key: key);

  @override
  _SpvSalesReservasiState createState() => _SpvSalesReservasiState();
}

class _SpvSalesReservasiState extends State<SpvSalesReservasi> {
  var isLoading = false;
  var isData = false;
