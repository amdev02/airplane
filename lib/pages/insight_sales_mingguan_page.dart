...
class InsightSalesMingguan extends StatefulWidget {
  final UserModelInsight model;
  InsightSalesMingguan(this.model);
  @override
  _InsightSalesMingguanState createState() => _InsightSalesMingguanState();
}

class _InsightSalesMingguanState extends State<InsightSalesMingguan> {
  var isLoading = false;
  var isData = false;
  ...
  Future<void> getHarian() async {
    ...
    list.clear();
    final response =
        await http.post(Uri.parse(BaseUrl.getInsightWeeklyBySales), body: {
