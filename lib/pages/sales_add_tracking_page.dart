...
class SalesAddTracking extends StatefulWidget {
  final VoidCallback reload;
  final LeadModel model;
  SalesAddTracking(this.model, this.reload);
  @override
  _SalesAddTrackingState createState() => _SalesAddTrackingState();
}

class _SalesAddTrackingState extends State<SalesAddTracking> {
  var isLoading = false;
