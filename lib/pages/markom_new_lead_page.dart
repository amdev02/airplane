...
import 'package:varana_apps/pages/markom_detail_new_lead.dart';
...
class MarkomNewLeadPage extends StatefulWidget {
  const MarkomNewLeadPage({Key? key}) : super(key: key);

  @override
  _MarkomNewLeadPageState createState() => _MarkomNewLeadPageState();
}

class _MarkomNewLeadPageState extends State<MarkomNewLeadPage> {
  var isLoading = false;
  var isData = false;
