...
import 'package:varana_apps/pages/spv_add_booking_page.dart';
...
class SpvDetailReservasiPage extends StatefulWidget {
  final LeadModel model;
  SpvDetailReservasiPage(this.model);
  @override
  _SpvDetailReservasiPageState createState() => _SpvDetailReservasiPageState();
}

class _SpvDetailReservasiPageState extends State<SpvDetailReservasiPage> {
  var isLoading = false;
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => SpvAddBookingPage(widget.model)));
              },
              child: Text(
                "Booking",
                style: whiteTextStyle,
