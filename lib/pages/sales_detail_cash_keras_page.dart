...
class SalesDetailCashKeras extends StatefulWidget {
  final LeadModel model;
  SalesDetailCashKeras(this.model);

  @override
  _SalesDetailCashKerasState createState() => _SalesDetailCashKerasState();
}

class _SalesDetailCashKerasState extends State<SalesDetailCashKeras> {
  var isLoading = false;
