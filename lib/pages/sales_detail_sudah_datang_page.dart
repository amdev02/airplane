...
import 'package:varana_apps/pages/sales_add_booking_visit.dart';
import 'package:varana_apps/pages/sales_add_reservasi_visit_page.dart';
...
class SalesDetailSudahDatangPage extends StatefulWidget {
  final VisitModel model;
  SalesDetailSudahDatangPage(this.model);
  @override
  _SalesDetailSudahDatangPageState createState() =>
      _SalesDetailSudahDatangPageState();
}

class _SalesDetailSudahDatangPageState
    extends State<SalesDetailSudahDatangPage> {
  var isLoading = false;
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SalesTambahReservasiVisit(widget.model)));
                },
                child: Text(
                  "Reservasi",
                  style: whiteTextStyle,
