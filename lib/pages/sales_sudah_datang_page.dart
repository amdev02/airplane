...
import 'package:varana_apps/pages/sales_detail_sudah_datang_page.dart';
...
class SalesSudahDatangPage extends StatefulWidget {
  const SalesSudahDatangPage({Key? key}) : super(key: key);

  @override
  _SalesSudahDatangPageState createState() => _SalesSudahDatangPageState();
}

class _SalesSudahDatangPageState extends State<SalesSudahDatangPage> {
  var isLoading = false;
  var isData = false;
