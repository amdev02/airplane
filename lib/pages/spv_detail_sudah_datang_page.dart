...
import 'package:varana_apps/pages/spv_add_booking_visit_page.dart';
import 'package:varana_apps/pages/spv_add_reservasi_visit_page.dart';
import 'package:varana_apps/pages/spv_add_tracking_visit_page.dart';
...
class SpvDetailSudahDatang extends StatefulWidget {
  final VisitModel model;
  SpvDetailSudahDatang(this.model);
  @override
  _SpvDetailSudahDatangState createState() => _SpvDetailSudahDatangState();
}

class _SpvDetailSudahDatangState extends State<SpvDetailSudahDatang> {
  var isLoading = false;
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SpvAddBookingVisit(widget.model)));
                },
                child: Text(
                  "Booking",
                  style: whiteTextStyle,
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              SpvAddReservasiVisitPage(widget.model)));
                },
                child: Text(
                  "Reservasi",
                  style: whiteTextStyle,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      SpvAddTrackingVsit(widget.model, getTracking)));
        },
