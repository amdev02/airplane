...
class SpvSalesDetailReservasi extends StatefulWidget {
  final LeadModel model;
  SpvSalesDetailReservasi(this.model);

  @override
  _SpvSalesDetailReservasiState createState() =>
      _SpvSalesDetailReservasiState();
}

class _SpvSalesDetailReservasiState extends State<SpvSalesDetailReservasi> {
  var isLoading = false;
