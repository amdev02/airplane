...
class SpvDetailCashBertahap extends StatefulWidget {
  final LeadModel model;
  SpvDetailCashBertahap(this.model);

  @override
  _SpvDetailCashBertahapState createState() => _SpvDetailCashBertahapState();
}

class _SpvDetailCashBertahapState extends State<SpvDetailCashBertahap> {
  var isLoading = false;
