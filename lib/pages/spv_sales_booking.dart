...
import 'package:varana_apps/pages/spv_sales_detail_booking.dart';
...
class SpvSalesBooking extends StatefulWidget {
  const SpvSalesBooking({Key? key}) : super(key: key);

  @override
  _SpvSalesBookingState createState() => _SpvSalesBookingState();
}

class _SpvSalesBookingState extends State<SpvSalesBooking> {
  var isLoading = false;
  var isData = false;
