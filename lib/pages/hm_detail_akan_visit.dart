...
class HmDetailAkanVisitPage extends StatefulWidget {
  final VisitModel model;
  HmDetailAkanVisitPage(this.model);

  @override
  _HmDetailAkanVisitPageState createState() => _HmDetailAkanVisitPageState();
}

class _HmDetailAkanVisitPageState extends State<HmDetailAkanVisitPage> {
  var isLoading = false;
