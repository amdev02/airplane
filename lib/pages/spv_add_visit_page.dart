...
class SpvAddVisitPage extends StatefulWidget {
  final LeadModel model;
  SpvAddVisitPage(this.model);

  @override
  _SpvAddVisitPageState createState() => _SpvAddVisitPageState();
}

class _SpvAddVisitPageState extends State<SpvAddVisitPage> {
  var isLoading = false;
