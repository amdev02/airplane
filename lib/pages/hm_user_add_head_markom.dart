...
class HmUserAddHeadMarkom extends StatefulWidget {
  final VoidCallback reload;
  HmUserAddHeadMarkom(this.reload);
  @override
  _HmUserAddHeadMarkomState createState() => _HmUserAddHeadMarkomState();
}

class _HmUserAddHeadMarkomState extends State<HmUserAddHeadMarkom> {
  var isLoading = false;
