...
class SpvAddBookingVisit extends StatefulWidget {
  final VisitModel model;
  SpvAddBookingVisit(this.model);

  @override
  _SpvAddBookingVisitState createState() => _SpvAddBookingVisitState();
}

class _SpvAddBookingVisitState extends State<SpvAddBookingVisit> {
  var isLoading = false;
