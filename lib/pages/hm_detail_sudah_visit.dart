...
class HmDetailSudahVisit extends StatefulWidget {
  final VisitModel model;
  HmDetailSudahVisit(this.model);
  @override
  _HmDetailSudahVisitState createState() => _HmDetailSudahVisitState();
}

class _HmDetailSudahVisitState extends State<HmDetailSudahVisit> {
  var isLoading = false;
