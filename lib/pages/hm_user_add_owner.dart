...
class HmUserAddOwner extends StatefulWidget {
  final VoidCallback reload;
  HmUserAddOwner(this.reload);

  @override
  _HmUserAddOwnerState createState() => _HmUserAddOwnerState();
}

class _HmUserAddOwnerState extends State<HmUserAddOwner> {
  var isLoading = false;
