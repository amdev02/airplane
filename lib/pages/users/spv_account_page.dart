...
class SpvAccountPage extends StatefulWidget {
  const SpvAccountPage({Key? key}) : super(key: key);

  @override
  _SpvAccountPageState createState() => _SpvAccountPageState();
}

class _SpvAccountPageState extends State<SpvAccountPage> {
  var isLoading = false;
  String name = "";
  String images = "";
  String username = "";
        ...
        child: Column(
          children: [
            PageReminder(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => MarkomAbsenPage()));
              },
              title: "Absen",
            ),
            SizedBox(
            ...
            PageReminder(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => SpvLeadSalesPage()));
              },
              title: "Lead Sales Anda",
            ),
            SizedBox(
              height: 20,
            ),
            PageReminder(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => SpvSalesSold()));
              },
              title: "Sold Sales Anda",
            ),
            SizedBox(
              height: 20,
            ),
