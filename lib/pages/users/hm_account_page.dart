...
import 'package:varana_apps/pages/users/hm_users_page.dart';
...
class HmAccount extends StatefulWidget {
  const HmAccount({Key? key}) : super(key: key);

  @override
  _HmAccountState createState() => _HmAccountState();
}

class _HmAccountState extends State<HmAccount> {
  var isLoading = false;
  String name = "";
  String images = "";
  String username = "";
        ...
        child: Column(
          children: [
            ...
            PageReminder(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => HmUsersPage()));
              },
              title: "Users",
            ),
            SizedBox(
            ...
            PageReminder(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => OwnerInsight()));
              },
              title: "Insight",
            ),
            SizedBox(
