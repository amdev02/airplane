...
class SpvSalesDetaiLBooking extends StatefulWidget {
  final LeadModel model;
  SpvSalesDetaiLBooking(this.model);

  @override
  _SpvSalesDetaiLBookingState createState() => _SpvSalesDetaiLBookingState();
}

class _SpvSalesDetaiLBookingState extends State<SpvSalesDetaiLBooking> {
  var isLoading = false;
