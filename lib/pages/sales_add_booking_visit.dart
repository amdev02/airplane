...
class SalesAddBookingVisit extends StatefulWidget {
  final VisitModel model;
  SalesAddBookingVisit(this.model);

  @override
  _SalesAddBookingVisitState createState() => _SalesAddBookingVisitState();
}

class _SalesAddBookingVisitState extends State<SalesAddBookingVisit> {
  var isLoading = false;
