...
class OwnerDetailReservasiPage extends StatefulWidget {
  ...
  OwnerDetailReservasiPage(this.model);
  @override
  _OwnerDetailReservasiPageState createState() =>
      _OwnerDetailReservasiPageState();
}

class _OwnerDetailReservasiPageState extends State<OwnerDetailReservasiPage> {
  var isLoading = false;
