...
class MarkomDetailKprPage extends StatefulWidget {
  final LeadModel model;
  MarkomDetailKprPage(this.model);
  @override
  _MarkomDetailKprPageState createState() => _MarkomDetailKprPageState();
}

class _MarkomDetailKprPageState extends State<MarkomDetailKprPage> {
  var isLoading = false;
