...
class SpvSalesDetailNewLead extends StatefulWidget {
  final LeadModel model;
  SpvSalesDetailNewLead(this.model);

  @override
  _SpvSalesDetailNewLeadState createState() => _SpvSalesDetailNewLeadState();
}

class _SpvSalesDetailNewLeadState extends State<SpvSalesDetailNewLead> {
  var isLoading = false;
