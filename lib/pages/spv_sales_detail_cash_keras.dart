...
class SpvSalesDetailCashKeras extends StatefulWidget {
  final LeadModel model;
  SpvSalesDetailCashKeras(this.model);

  @override
  _SpvSalesDetailCashKerasState createState() =>
      _SpvSalesDetailCashKerasState();
}

class _SpvSalesDetailCashKerasState extends State<SpvSalesDetailCashKeras> {
  var isLoading = false;
