...
import 'package:varana_apps/pages/markom_detail_reservasi_page.dart';
...
class MarkomReservasiPage extends StatefulWidget {
  const MarkomReservasiPage({Key? key}) : super(key: key);

  @override
  _MarkomReservasiPageState createState() => _MarkomReservasiPageState();
}

class _MarkomReservasiPageState extends State<MarkomReservasiPage> {
  var isLoading = false;
  var isData = false;
