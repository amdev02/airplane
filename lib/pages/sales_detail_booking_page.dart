...
import 'package:varana_apps/pages/sales_add_sold_page.dart';
...
class SalesDetailBookingPage extends StatefulWidget {
  ...
  SalesDetailBookingPage(this.model);

  @override
  _SalesDetailBookingPageState createState() => _SalesDetailBookingPageState();
}

class _SalesDetailBookingPageState extends State<SalesDetailBookingPage> {
  var isLoading = false;
            ...
            child: TextButton(
              onPressed: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => SalesAddSoldPage(widget.model)));
              },
              child: Text(
                "Sold",
                style: whiteTextStyle,
