...
import 'package:varana_apps/pages/spv_sales_detail_new_lead.dart';
...
class SpvSalesNewLead extends StatefulWidget {
  const SpvSalesNewLead({Key? key}) : super(key: key);

  @override
  _SpvSalesNewLeadState createState() => _SpvSalesNewLeadState();
}

class _SpvSalesNewLeadState extends State<SpvSalesNewLead> {
  var isLoading = false;
  var isData = false;
