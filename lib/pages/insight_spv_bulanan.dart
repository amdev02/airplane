...
class InsightSpvBulanan extends StatefulWidget {
  final UserModelInsight model;
  InsightSpvBulanan(this.model);

  @override
  _InsightSpvBulananState createState() => _InsightSpvBulananState();
}

class _InsightSpvBulananState extends State<InsightSpvBulanan> {
  var isLoading = false;
  var isData = false;
