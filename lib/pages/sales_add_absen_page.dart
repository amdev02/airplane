...
class SalesAddAbsenPage extends StatefulWidget {
  @override
  _SalesAddAbsenPageState createState() => _SalesAddAbsenPageState();
}

class _SalesAddAbsenPageState extends State<SalesAddAbsenPage> {
  var isLoading = false;
