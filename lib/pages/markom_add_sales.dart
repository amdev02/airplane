...
class MarkomAddSalesPage extends StatefulWidget {
  final VoidCallback reload;
  MarkomAddSalesPage(this.reload);
  @override
  _MarkomAddSalesPageState createState() => _MarkomAddSalesPageState();
}

class _MarkomAddSalesPageState extends State<MarkomAddSalesPage> {
  var isLoading = false;
